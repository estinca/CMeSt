...
@Service
public class SetupServiceRDBMS implements SetupService {

    private static final String[] TABLES_NEEDED = {"users", "user_roles"};
	private final DataSource dataSource;
    private final PasswordEncoder passwordEncoder;
    private final UserServiceRDBMS userService;
    private final Map<String, String> rawSettings;

    @Autowired
    public SetupServiceRDBMS(DataSource dataSource, PasswordEncoder passwordEncoder, UserServiceRDBMS userService,
    ...
    public void setupRepository() {
    	...
    	schemaExport.execute(EnumSet.of(TargetType.DATABASE), SchemaExport.Action.BOTH, metadataSources.buildMetadata());
