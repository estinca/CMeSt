...
@Directive({
  selector: '[cmsSidebarToggler]'
})
export class SidebarToggleDirective implements OnInit {
  @Input('cmsSidebarToggler') breakpoint: string;
...
@Directive({
  selector: '[cmsMobileSidebarToggler]'
})
 ...
 */
@Directive({
  selector: '[cmsAsideMenuToggler]',
})
export class AsideToggleDirective implements OnInit {
  @Input('cmsAsideMenuToggler') breakpoint: string;
